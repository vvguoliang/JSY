...
public class BannerLoopAdapter2 extends PagerAdapter implements View.OnClickListener {
    ...
    public BannerLoopAdapter2(Context context, List<ImageView> _list, List<Map<String, String>> mapList) {
        this.list = _list;
...
//            ((ViewPager) container).removeView((View)object);
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (vp != null) {
            ...
            parent.removeView(list.get(position1));
        }
