...
public class LoanBrowsHolder extends BaseViewHolder<LoanBrowsData> {
    ...
    public LoanBrowsHolder(Context context, ViewGroup parent) {
        super( context, parent, R.layout.holder_loan_record );
        this.parent = parent;
    }

    @Override
    public void setData(LoanBrowsData data) {
        super.setData( data );
        if (data != null) {
...
//            record_loan_money.setText( data.getPro_describe() );
            ...
            record_loan_button.setVisibility(View.INVISIBLE);
        }
    }
    ...
    @Override
    public void onItemViewClick(LoanBrowsData data) {
